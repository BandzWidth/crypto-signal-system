...
class SolanaPage {
    ...
    async init() {
        console.log('Initializing Solana page...');
        ...
        this.hideLoading();
        console.log('Solana page initialization complete');
    }
    ...
    initializeChart() {
        console.log('Initializing TradingView chart for Solana...');
        // Use the TradingViewChart class for full control
        this.chart = new TradingViewChart('tradingview-chart', 'BINANCE:SOLUSDT', { defaultTimeframe: '60' });
    }
...
document.addEventListener('DOMContentLoaded', () => {
    window.solanaPage = new SolanaPage();
});

// Cleanup on page unload
window.addEventListener('beforeunload', () => {
    if (window.solanaPage) {
        window.solanaPage.destroy();
    }
}); 