...
class EthereumPage {
    ...
    async init() {
        console.log('Initializing Ethereum page...');
        ...
        this.hideLoading();
        console.log('Ethereum page initialization complete');
    }
    ...
    initializeChart() {
        console.log('Initializing TradingView chart for Ethereum...');
        // Use the TradingViewChart class for full control
        this.chart = new TradingViewChart('tradingview-chart', 'BINANCE:ETHUSDT', { defaultTimeframe: '60' });
    }
...
document.addEventListener('DOMContentLoaded', () => {
    window.ethereumPage = new EthereumPage();
});

// Cleanup on page unload
window.addEventListener('beforeunload', () => {
    if (window.ethereumPage) {
        window.ethereumPage.destroy();
    }
}); 